...
export const metadata: Metadata = {
  ...
  description: 'Report and track community issues like water supply, potholes, garbage, and more on an interactive map.',
  keywords: 'community issues, report problems, civic engagement, water supply, infrastructure',
